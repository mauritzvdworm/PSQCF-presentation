...
portfoliolive <- portfoliolive[flag != "Backtest" ,.(date, PnL = return, type = flag)]
...
portfolioReturns <- portfolioReturns[flag != "Backtest"]

portfolioReturns[, SnPnormalised := (SnPnormalised/portfolioReturns[1, SnPnormalised] - 1) * 100]
portfolioReturns[, SnPnormalised := na.locf(SnPnormalised)]
...
portfolioReturns[, flag := ifelse(variable == "S&P", "S&P", flag)]
