...
tbl1live <- table.AnnualizedReturns(rbind(BB1live[date < BB1PSQCF[, min(date)], .(date, `BB1 live` = PnL)], BB1PSQCF[,.(date, `BB1 live` = PnL)]))
...
tbl2live <- table.AnnualizedReturns(rbind(BB2live[date < BB2PSQCF[, min(date)], .(date, `BB2 live` = PnL)], BB2PSQCF[, .(date, `BB2 live` = PnL)]))
...
tbl1live <- table.AnnualizedReturns(rbind(TR1live[date < TR1PSQCF[, min(date)], .(date, `TR1 live` = PnL)], TR1PSQCF[, .(date, `TR1 live` = PnL)]))
nms <- row.names(tbl1live)
tbl1live <- as.data.table(tbl1live)
tbl1live[, variable := nms]
